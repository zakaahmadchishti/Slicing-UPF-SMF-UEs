...
*   [Literature Review](https://github.com/zakaahmadchishti/Slicing-UPF-SMF-UEs/edit/main/README.md#2-literature-review)
    ...
    *   [Why Network Slicing?](Why_Network_Slicing?)
    *   [Role of NFs in Slicing](Role_of_NFs_in_Slicing)
* [Architecture Overview](Architecture_Overview)
   * [Topology Design and Slicing Based on Application](Topology_Design_and_Slicing)
   * [Design Challenges and Limitations](Design_Challenges_and_Limitations)
* [Requirements and Planning](Requirements_and_Planning)
   * [Hardware and Development Requirements](Hardware_and_Development_Requirements)
   * [Milestones and Issues](Milestones_and_Issues)
* [Development and Deployment](Development_and_Deployment)
   * [Setting Up the Docker Environment](Setting_Up_Docker_Environment)
   * [Repo Clone and Test Deployments](Repo_Clone_and_Test_Deployments)
   * [Creating Multiple NFs](Creating_Multiple_NFs)
   * [PDU Session Creation](PDU_Session_Creation)
   * [Multiple Slicing](Multiple_Slicing)
   * [Completion of Network Architecture](Completion_of_Network_Architecture)
   * [Adding Prometheus and Grafana](Adding_Prometheus_and_Grafana)
   * [Alert Manager](Alert_Manager)
   * [Webhook](Webhook)
   * [Communication b/w Dockers](Communication_between_Dockers)
   * [Python Script and Flask Application](Python_Script_and_Flask_Application)
   * [Deploying Webhook Package under Project Docker](Deploying_Webhook_Package)
   * [cAdvisor](cAdvisor)
* [Management and Orchestration](Management_and_Orchestration)
   * [Adding all NFs in Prometheus](Adding_NFs_in_Prometheus)
   * [Dashboards in Grafana](Dashboards_in_Grafana)
   * [Database Connectivity, Storage, and Processing](Database_Connectivity_Storage_Processing)
   * [Creating an Alert](Creating_an_Alert)
   * [Triggering Alert and Webhook Communication](Triggering_Alert_and_Webhook_Communication)
   * [Python Script Container Deployment](Python_Script_Container_Deployment)
   * [Limitation of Docker Compose](Limitation_of_Docker_Compose)
   * [Docker Swarm and Limitations](Docker_Swarm_and_Limitations)
   * [Restart Policy and Other Policies](Restart_Policy_and_Other_Policies)
   * [Management and Orchestration Workflow](Management_and_Orchestration_Workflow)
* [Testing Script](Testing_Script)
   * [iperf3 Testing of UEs](iperf3_Testing_of_UEs)
   * [Registering Multiple UEs and Establishing PDU Sessions](Registering_Multiple_UEs_and_Establishing_PDU_Sessions)
   * [Network Slicing Verification](Network_Slicing_Verification)
   * [Packetrusher](Packetrusher)
   * [Performance Testing (Throughput & Latency)](Performance_Testing_Throughput_Latency)
   * [Failure Recovery Test](Failure_Recovery_Test)
